    ...
    <>
      <div className="bg-base-100">
        <div className="container mx-auto">
          <div role="article" className="bg-base-100 py-12 md:px-8">
            <div className="px-4 xl:px-0 py-10">
              <div className="flex flex-col lg:flex-row flex-wrap">
                <div className="mt-4 lg:mt-0 lg:w-3/5">
                  <div>
                    <h1 className="text-3xl ml-2 lg:ml-0 lg:text-4xl font-bold text-white tracking-normal lg:w-11/12">
                ...
                <div className="lg:w-2/5 flex mt-10 ml-2 lg:ml-0 lg:mt-0 lg:justify-end">
                  <div className="pt-2 relative  text-gray-600">
                    <input
                      className="focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 bg-base-300 h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
                      type="search"
                      name="search"
                      placeholder="Search"
                    />
                    <button
                      type="submit"
                      className="focus:ring-2 focus:ring-offset-2 text-gray-600 focus:text-indigo-700 focus:rounded-full  focus:bg-gray-100 focus:ring-indigo-700 bg-base-300 focus:outline-none absolute right-0 top-0 mt-5 mr-4"
                    >
                      <svg
            ...
            <div className="px-6 xl:px-0">
              <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 pb-6 gap-8">
                <div role="cell" className="bg-base-100">
                  <div className="bg-base-300 p-5 rounded-md relative h-full w-full">
                ...
                <div role="cell" className="bg-base-100">
                  <div className="bg-base-300 p-5 rounded-md  h-full relative w-full">
                    {/* class="absolute inset-0 object-center object-cover h-full w-full"  */}
                    <span>
                      <img
                        className="bg-base-200 p-2 mb-5 rounded-full"
                ...
                <div role="cell" className="bg-gray-100">
                  <div className="relative bg-base-300 p-5 rounded-md h-full w-full">
                    {/* class="absolute inset-0 object-center object-cover h-full w-full"  */}
                    <span>
                      <img
                        className="bg-gray-200 p-2 mb-5 rounded-full"
